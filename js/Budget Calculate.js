...
function getTotalSave() {
    ...
    var disVal = Number(document.getElementById("discount").value);
    var savVal = priceVal * (disVal / 100);
    var totalVal = priceVal - savVal;
    document.getElementById("total").value = totalVal.toFixed(2);
    document.getElementById("save").value = savVal.toFixed(2);
}
function getTotalPrice() {
    var disVal = Number(document.getElementById("discount").value);
    var saveVal = Number(document.getElementById("save").value);
    var priceVal = Number((saveVal * 100) / disVal);
    var totalVal = priceVal - saveVal;
    document.getElementById("total").value = totalVal.toFixed(2);
...
function getDiscountTotal() {
    var priceVal = Number(document.getElementById("price").value);
    var saveVal = Number(document.getElementById("save").value);
    var disVal = Number((saveVal * 100) / priceVal);
    var totalVal = priceVal - saveVal;
    document.getElementById("total").value = totalVal.toFixed(2);
    document.getElementById("discount").value = disVal.toFixed(2);
}
function getDiscountSave() {
    var priceVal = Number(document.getElementById("price").value);
    var totalVal = Number(document.getElementById("total").value);
    var savVal = Number(priceVal - totalVal);
    var disVal = (totalVal * 100) / priceVal;
    document.getElementById("discount").value = disVal.toFixed(2);
    document.getElementById("save").value = savVal.toFixed(2);
}
function getDiscountPrice() {
    var saveVal = Number(document.getElementById("save").value);
    var totalVal = Number(document.getElementById("total").value);
    var priceVal = Number(totalVal + saveVal);
    var disVal = (totalVal * 100) / priceVal;
    document.getElementById("price").value = priceVal.toFixed(2);
    document.getElementById("discount").value = disVal.toFixed(2);
}
function getPriceSave() {
    var totalVal = Number(document.getElementById("total").value);
    var disVal = Number(document.getElementById("discount").value);
    var priceVal = Number((totalVal * 100) / (100 - disVal));
    var saveVal = priceVal - totalVal;
    document.getElementById("save").value = saveVal.toFixed(2);
    document.getElementById("price").value = priceVal.toFixed(2);
}
$(".calc-box").on("click", ".reset-btn", function () {
    document.getElementById("price").value = "";
    document.getElementById("discount").value = "";
    document.getElementById("total").value = "";
    document.getElementById("save").value = "";
});
$(".calc-box").on("keyup", "#price", function () {
    var priceVal = document.getElementById("price").value;
    var disVal = document.getElementById("discount").value;
    var saveVal = document.getElementById("save").value;
    var totalVal = document.getElementById("total").value;
    if (priceVal != "" && disVal != "") {
        getTotalSave();
    }
    else if (priceVal !== "" && saveVal !== "") {
        getDiscountTotal();
    }
    else if (priceVal !== "" && totalVal !== "") {
        getDiscountSave();
    }
});
$(".calc-box").on("keyup", "#discount", function () {
    var priceVal = document.getElementById("price").value;
    var disVal = document.getElementById("discount").value;
    var saveVal = document.getElementById("save").value;
    var totalVal = document.getElementById("total").value;
    ...
    else if (disVal !== "" && saveVal !== "") {
        getTotalPrice();
    }
    else if (disVal !== "" && totalVal !== "") {
        getPriceSave();
    }
});
$(".calc-box").on("keyup", "#total", function () {
    var priceVal = document.getElementById("price").value;
    var disVal = document.getElementById("discount").value;
    var saveVal = document.getElementById("save").value;
    var totalVal = document.getElementById("total").value;
    if (priceVal !== "" && totalVal !== "") {
        getDiscountSave();
    }
    else if (disVal !== "" && totalVal !== "") {
        getPriceSave();
    }
    else if (saveVal !== "" && totalVal !== "") {
        getDiscountPrice();
    }
});
$(".calc-box").on("keyup", "#save", function () {
    var priceVal = document.getElementById("price").value;
    var disVal = document.getElementById("discount").value;
    var saveVal = document.getElementById("save").value;
    var totalVal = document.getElementById("total").value;
